...
<?php
    if (isset($_REQUEST['command'])):
         require_once('data-updateconfirm.php');?>
        <div class="l-wideColumn l-wideColumn--first">
        <div class="BorderBox">
        <?php
        if ($update):
            ;?>
            <p class="BorderBox__body title">更新に成功しました。</p>
            <meta http-equiv="refresh" content="1; URL=posts.php">
            <?php
        else:
            ;?>
            <p class="BorderBox__body title">更新に失敗しました。</p>
    ...
    <div class="container">
        <div class="section">
            ...
            <form class="ib" action="./update-confirm.php" method="post">
...
<input type="hidden" name="text" value='<?php echo $_REQUEST['text'];?>'>
 ...
 ;?>
   ...
   <form class="ib" action="./update-correction.php" method="post">
       <input type="hidden" name="id" value="<?php echo $_REQUEST['id'];?>">
        <input type="hidden" name="title1" value="<?php echo $_REQUEST['title1'];?>">
       <input type="hidden" name="title2" value="<?php echo $_REQUEST['title2'];?>">
<input type="hidden" name="text" value='<?php echo $_REQUEST['text'];?>'>
